...
<a href="https://wa.me/1234567890" target="_blank" class="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 animate-bounce-subtle">
...
<footer class="bg-stone-900 text-stone-300 py-12 mt-auto">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
                 <h4 class="text-lg font-bold text-white mb-4">Boletín</h4>
                 <p class="text-xs text-stone-400 mb-4">Suscríbete para recibir las últimas novedades.</p>
                 <div class="flex">
                    <input type="email" placeholder="Tu email" class="bg-stone-800 border-none rounded-l-lg px-4 py-2 text-sm text-white focus:ring-1 focus:ring-spa-500 w-full">
                    <button class="bg-spa-600 hover:bg-spa-500 text-white px-4 py-2 rounded-r-lg text-sm transition-colors">Enviar</button>
                 </div>
            </div>
        </div>
