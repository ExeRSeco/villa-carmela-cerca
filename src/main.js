...
<button id="scroll-top-btn" class="fixed bottom-24 right-6 z-40 bg-spa-600 hover:bg-spa-700 text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 opacity-0 invisible translate-y-4" aria-label="Volver arriba">
