        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
            ...
            <div class="bg-white rounded-3xl shadow-lg border border-stone-100 overflow-hidden flex flex-col hover:shadow-xl transition-shadow duration-300 relative group">
                ...
                <div class="p-8 pt-0 mt-auto">
                    <a href="https://wa.me/5491100000000?text=Hola,%20me%20interesa%20contratar%20el%20Plan%20Básico%20de%20la%20Guía%20Amarilla" target="_blank" class="block w-full text-center bg-stone-100 hover:bg-stone-200 text-stone-800 font-bold py-4 rounded-xl transition-colors">
